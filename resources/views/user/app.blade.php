    ...
    <div class="site-wrap">
        <header class="site-navbar" role="banner">
            <div class="site-navbar-top">
                <div class="container">
                    <nav class="site-navigation text-right text-md-right fixed-top bg-light" role="navigation">
                        <div class="container">
                          <ul class="site-menu js-clone-nav d-none d-md-block">
                            <li style="float: left;margin-top: 12px;color:rgb(41, 41, 41);" href="{{ route('home') }}"><h5>Hijab Uni Aisah</h5></li>
                                ...
                                @if (Route::has('login'))
                                        ...
                                        <li>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{ route('user.alamat') }}">Pengaturan
                                                        Alamat</a>
                                    ...
                                    <li>
                                      <form action="{{ route('user.produk.cari') }}" method="get" class="site-block-top-search shadow">
                                        @csrf
