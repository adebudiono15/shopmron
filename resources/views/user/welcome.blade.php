@extends('user.app')
@section('content')
    <div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/hero_1.jpg);"
        data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-6 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2" style="color: #fff;text-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15)!important;">Mau cari hijab? YUK SINI</h1>
                    <div class="intro-text text-center text-md-left">
                        <p class="mb-4" style="color: #fff;text-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15)!important;">Kami jamin kualitas OK! </p>
                        <p>
                            <a href="{{ route('user.produk') }}" style="background-color: #7C83FD !important;" class="btn btn-sm btn-primary">Belanja Sekarang</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 text-center text-md-left pt-5 pt-md-0">
