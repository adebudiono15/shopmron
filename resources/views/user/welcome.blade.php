        ...
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-6 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2" style="color: #fff;text-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15)!important;">Cari Kebutuhan Peralatan Jaringan Kamu Di Sini</h1>
                    <div class="intro-text text-center text-md-left">
                        <p class="mb-4" style="color: #fff;text-shadow:0 0.5rem 1rem rgba(0, 0, 0, 0.15)!important;">Alat peralatan jaringan disini terjamin kualitasnya dan tentunya barangnya juga original bukan
                            kw. </p>
                        <p>
